 ...
 */
public class LeaderboardSetPrimarySignCommand extends BaseCommand {

    @Command(name = "leaderboard.setprimarysign", aliases = {"leaderboard.setps", "leaderboard.setprimesign", "leaderboard.setmainsign"}, permission = "carbyne.command.leaderboard", inGameOnly = true)
    public void onCommand(CommandArgs command) {
        ...
        leaderboard.setPrimarySignLocation(block.getLocation());
        leaderboard.save();

        MessageManager.sendMessage(player, "&aThe primary sign location has been set.");
    }
}
