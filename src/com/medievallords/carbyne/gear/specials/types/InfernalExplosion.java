...
public class InfernalExplosion implements Special {
    ...
    public void callSpecial(Player caster) {
        ...
        for (Entity entity : caster.getNearbyEntities(5, 5, 5)) {
    ...
    public void runFireworks(Location location, FireworkEffect.Type type, List<Color> colors) {
        Firework firework = (Firework) location.getWorld().spawnEntity(location, EntityType.FIREWORK);
        org.bukkit.FireworkEffect effect = org.bukkit.FireworkEffect.builder().with(type).withColor(colors).build();
