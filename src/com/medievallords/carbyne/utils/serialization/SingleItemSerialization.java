package com.medievallords.carbyne.utils.serialization;

import com.medievallords.carbyne.utils.serialization.json.JSONArray;
import com.medievallords.carbyne.utils.serialization.json.JSONException;
import com.medievallords.carbyne.utils.serialization.json.JSONObject;
    ...
    public static ItemStack getItem(JSONObject item, int index) {
        try {
            ...
            if((mat == Material.BOOK_AND_QUILL || mat == Material.WRITTEN_BOOK) && item.has("book-meta")) {
                ...
                stuff.setItemMeta(meta);
            } else if(isLeatherArmor(mat) && item.has("armor-meta")) {
